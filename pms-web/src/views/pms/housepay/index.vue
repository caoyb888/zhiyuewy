                        ...
                        <el-row :gutter="16" :style="'width:100%'">
                            <el-col :span="4">
                                <el-form-item label="编号" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ house.name }}</label>
                                </el-form-item>
                            </el-col>
                            <el-col :span="4">
                                <el-form-item label="商铺状态" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35" v-if="contract.contractType == 'rented'">出租</label>
                                    <label style="color: #FF6B35" v-if="contract.contractType == 'selled'">出售</label>
                                </el-form-item>
                            </el-col>
                            <el-col :span="4">
                                <el-form-item label="到期日期" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ contract.endDate }}</label>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="16" :style="'width:100%'">
                            <el-col :span="4">
                                <el-form-item label="占地面积" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ house.buildingSquare }}</label>
                                </el-form-item>
                            </el-col>
                            <el-col :span="4">
                                <el-form-item label="使用面积" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ house.useSquare }}</label>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="行业" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ contract.userTrade }}</label>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row :gutter="16" :style="'width:100%'">
                            <el-col :span="4">
                                <el-form-item label="客户姓名" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ contract.userName }}</label>
                                </el-form-item>
                            </el-col>
                            <el-col :span="4">
                                <el-form-item label="联系方式" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ contract.userPhone }}</label>
                                </el-form-item>
                            </el-col>
                            <el-col :span="4">
                                <el-form-item label="入住时间" style="margin-bottom: 0px">
                                    <label style="color: #FF6B35">{{ contract.beginDate }}</label>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </el-form>
